...
/** Contrato existe e ainda não foi assinado (tag no funil) */
export function isAwaitingSignature(leadOrContract, maybeContract) {
  const contract =
    maybeContract !== undefined
      ? maybeContract
      : leadOrContract?.contract || leadOrContract;
